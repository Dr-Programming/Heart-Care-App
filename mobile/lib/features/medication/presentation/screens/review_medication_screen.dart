...
class ReviewMedicationScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final MedicationInstructions instructionsValue =
        instructions ?? MedicationInstructions.none;
          ...
          SectionCard(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _StatusRow(label: 'meds.review.reminder'.tr(), on: !isAsNeeded),
                _StatusRow(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _StatusPill(
            on: on,
            label: on ? 'meds.review.on'.tr() : 'meds.review.off'.tr(),
          ),
        ],
      ),
    );
